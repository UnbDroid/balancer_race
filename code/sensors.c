...
void update_imu()
{
	...
	imu.accel.posX = atan((double)imu.accel.rawZ/(double)imu.accel.rawY);
	imu.accel.posY = atan((double)imu.accel.rawX/(double)imu.accel.rawZ);
	imu.accel.posZ = atan((double)imu.accel.rawY/(double)imu.accel.rawX);
