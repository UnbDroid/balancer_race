...
void update_imu()
{
	...
	imu.accel.posX = (double)imu.accel.rawZ/(double)imu.accel.rawY;
	imu.accel.posY = (double)imu.accel.rawX/(double)imu.accel.rawZ;
	imu.accel.posZ = (double)imu.accel.rawY/(double)imu.accel.rawX;
