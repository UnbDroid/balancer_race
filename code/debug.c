...
void update_debug(struct debug_data* debug)
{
	...
	printf("\033[%d;%dH%07.2f\n", 29, 32, debug->imu.magnet.posX);
	
	printf("\033[%d;%dH%07.2f\n", 30, 5, debug->imu.gyro.posY);
	printf("\033[%d;%dH%07.2f\n", 30, 20, debug->imu.accel.posY);
	printf("\033[%d;%dH%07.2f\n", 30, 32, debug->imu.magnet.posY);

	printf("\033[%d;%dH%07.2f\n", 31, 5, debug->imu.gyro.posZ);
	printf("\033[%d;%dH%07.2f\n", 31, 20, debug->imu.accel.posZ);
	printf("\033[%d;%dH%07.2f\n", 31, 32, debug->imu.magnet.posZ);

	printf("\033[%d;%dH%07.2f\n", 32, 5, debug->imu.gyro.velX);
	printf("\033[%d;%dH%07.2f\n", 32, 20, debug->imu.accel.velX);
	printf("\033[%d;%dH%07.2f\n", 32, 32, debug->imu.magnet.velX);

	printf("\033[%d;%dH%07.2f\n", 33, 5, debug->imu.gyro.velY);
	printf("\033[%d;%dH%07.2f\n", 33, 20, debug->imu.accel.velY);
	printf("\033[%d;%dH%07.2f\n", 33, 32, debug->imu.magnet.velY);

	printf("\033[%d;%dH%07.2f\n", 34, 5, debug->imu.gyro.velZ);
	printf("\033[%d;%dH%07.2f\n", 34, 20, debug->imu.accel.velZ);
	printf("\033[%d;%dH%07.2f\n", 34, 32, debug->imu.magnet.velZ);

	printf("\033[%d;%dH%07.2f\n", 35, 5, debug->imu.gyro.accX);
	printf("\033[%d;%dH%07.2f\n", 35, 20, debug->imu.accel.accX);
	printf("\033[%d;%dH%07.2f\n", 35, 32, debug->imu.magnet.accX);

	printf("\033[%d;%dH%07.2f\n", 36, 5, debug->imu.gyro.accY);
	printf("\033[%d;%dH%07.2f\n", 36, 20, debug->imu.accel.accY);
	printf("\033[%d;%dH%07.2f\n", 36, 32, debug->imu.magnet.accY);

	printf("\033[%d;%dH%07.2f\n", 37, 5, debug->imu.gyro.accZ);
	printf("\033[%d;%dH%07.2f\n", 37, 20, debug->imu.accel.accZ);
	printf("\033[%d;%dH%07.2f\n", 37, 32, debug->imu.magnet.accZ);

	printf("\033[%d;%dH%06d\n", 38, 5, debug->imu.gyro.rawX);
	printf("\033[%d;%dH%06d\n", 38, 20, debug->imu.accel.rawX);
	printf("\033[%d;%dH%06d\n", 38, 32, debug->imu.magnet.rawX);

	printf("\033[%d;%dH%06d\n", 39, 5, debug->imu.gyro.rawY);
	printf("\033[%d;%dH%06d\n", 39, 20, debug->imu.accel.rawY);
	printf("\033[%d;%dH%06d\n", 39, 32, debug->imu.magnet.rawY);

	printf("\033[%d;%dH%06d\n", 40, 5, debug->imu.gyro.rawZ);
	printf("\033[%d;%dH%06d\n", 40, 20, debug->imu.accel.rawZ);
	printf("\033[%d;%dH%06d\n", 40, 32, debug->imu.magnet.rawZ);
