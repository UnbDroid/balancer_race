...
public class matlab_supervisorio extends PApplet {
...
public void setup() {
    ...
    agora_eu_sou_o_mestre = new Server(this, 9002);
}
...
public void criaCorpo(float x, float y, float z, int r, int g, int b)
{
...
public void drawCylinder(float topRadius, float bottomRadius, float tall, int sides) {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "matlab_supervisorio" };
    if (passedArgs != null) {
